...
running `rstan`. The SE is calculated as $\sqrt{\hat{p}(1-\hat{p})/N_{\text{draws}}}$, where $\hat{p}$ is the estimated PoS and $N_{\text{draws}}$ is the total number of post-warmup MCMC draws.
