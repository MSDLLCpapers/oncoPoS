...
s_0 \sim \mathcal{N}(0,\ 1^2), \quad
s_1 \sim \mathcal{N}(0,\ 1^2), \quad
\sigma_{\text{WLS}} \sim \mathcal{N}(0,\ 2.5^2)
$$
...
response bounds (default = 95%). Lower values may be used for more
